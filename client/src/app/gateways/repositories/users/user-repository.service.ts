...
import type { ViewStructureLevel } from '@app/site/pages/meetings/pages/participants/pages/structure-levels/view-models';
...
import type { ViewUser } from '../../../site/pages/meetings/view-models/view-user';
