...
export enum ActionType {
    ...
    MOTION_FOLLOW_RECOMMENDATION = 'motion.follow_recommendation',
    ...
    MOTION_CATEGORY_CREATE = 'motion_category.create',
    MOTION_CATEGORY_UPDATE = 'motion_category.update',
    MOTION_CATEGORY_DELETE = 'motion_category.delete',
    MOTION_CATEGORY_SORT = 'motion_category.sort',
    MOTION_CATEGORY_SORT_MOTIONS = 'motion_category.sort_motions_in_category',
    MOTION_CATEGORY_NUMBER_MOTIONS = 'motion_category.number_motions',
    ...
    MOTION_STATUTE_PARAGRAPH_CREATE = 'motion_statute_paragraph.create',
    MOTION_STATUTE_PARAGRAPH_UPDATE = 'motion_statute_paragraph.update',
    MOTION_STATUTE_PARAGRAPH_DELETE = 'motion_statute_paragraph.delete',
