...
_('Serially numbered');
_('Set it manually');
_('Number of minimal digits for number');
_('Uses leading zeros to sort motions correctly by number.');
_('Allow blank in number');
...
_('Prefix for the number for amendments');
