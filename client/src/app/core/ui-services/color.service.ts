...
export class ColorService {
    ...
    public generateColorPaletteByHex(colorHex: string): ColorDefinition[] {
        ...
        return [
            ...
            this.createColorObject(tinycolor.mix(baseDark, undefined, 15).saturate(80).lighten(65), `A100`),
            this.createColorObject(tinycolor.mix(baseDark, undefined, 15).saturate(80).lighten(55), `A200`),
            this.createColorObject(tinycolor.mix(baseDark, undefined, 15).saturate(100).lighten(45), `A400`),
            this.createColorObject(tinycolor.mix(baseDark, undefined, 15).saturate(100).lighten(40), `A700`)
        ];
    }
