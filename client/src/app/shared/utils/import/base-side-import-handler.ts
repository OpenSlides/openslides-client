...
import { ImportFind, ImportFindProperties, ImportResolveHandler } from './import-utils';
    ...
    implements SideImportHandler<MainModel, SideModel>
{
    ...
    private _createFn: (entries: CsvMapping<SideModel>[]) => Promise<Identifiable[]>;
    ...
    public constructor(config: BaseSideImportHandlerConfig<MainModel, SideModel>) {
        ...
        this.setCreateFn(config.createFn, config.repo);
