...
export const permissionChildren: PermissionsMap = {
    ...
    "motion.can_manage": [Permission.motionCanManageMetadata, Permission.motionCanSee, Permission.motionCanManagePolls, Permission.motionCanSeeInternal, Permission.motionCanCreate, Permission.motionCanCreateAmendments, Permission.motionCanForward, ],
...
export const permissionParents: PermissionsMap = {
    ...
    "agenda_item.can_see": [Permission.agendaItemCanSeeInternal, Permission.agendaItemCanManage, Permission.agendaItemCanSeeModeratorNotes, Permission.agendaItemCanManageModeratorNotes, ],
    ...
    "assignment.can_see": [Permission.assignmentCanNominateOther, Permission.assignmentCanManage, Permission.assignmentCanNominateSelf, ],
    "chat.can_manage": [],
    "list_of_speakers.can_be_speaker": [],
    ...
    "motion.can_see": [Permission.motionCanManageMetadata, Permission.motionCanManage, Permission.motionCanManagePolls, Permission.motionCanSeeInternal, Permission.motionCanCreate, Permission.motionCanCreateAmendments, Permission.motionCanForward, Permission.motionCanSupport, ],
