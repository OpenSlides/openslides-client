...
export class Organization extends BaseModel<Organization> {
    ...
    public static readonly REQUESTABLE_FIELDS: (keyof Organization)[] = [`id`, `name`, `description`, `legal_notice`, `privacy_policy`, `login_text`, `reset_password_verbose_errors`, `gender_ids`, `enable_electronic_voting`, `enable_chat`, `limit_of_meetings`, `limit_of_users`, `default_language`, `require_duplicate_from`, `enable_anonymous`, `saml_enabled`, `saml_login_button_text`, `saml_attr_mapping`, `saml_metadata_idp`, `saml_metadata_sp`, `saml_private_key`, `committee_ids`, `active_meeting_ids`, `archived_meeting_ids`, `template_meeting_ids`, `organization_tag_ids`, `theme_id`, `theme_ids`, `mediafile_ids`, `published_mediafile_ids`, `user_ids`, `users_email_sender`, `users_email_replyto`, `users_email_subject`, `users_email_body`, `url`];
}
