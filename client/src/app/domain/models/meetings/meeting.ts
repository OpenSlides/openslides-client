...
export class Meeting extends BaseModel<Meeting> {
    ...
    public static readonly REQUESTABLE_FIELDS: (keyof Meeting)[] = [`id`, `external_id`, `welcome_title`, `welcome_text`, `name`, `is_active_in_organization_id`, `is_archived_in_organization_id`, `description`, `location`, `start_time`, `end_time`, `locked_from_inside`, `imported_at`, `language`, `jitsi_domain`, `jitsi_room_name`, `jitsi_room_password`, `template_for_organization_id`, `enable_anonymous`, `custom_translations`, `conference_show`, `conference_auto_connect`, `conference_los_restriction`, `conference_stream_url`, `conference_stream_poster_url`, `conference_open_microphone`, `conference_open_video`, `conference_auto_connect_next_speakers`, `conference_enable_helpdesk`, `applause_enable`, `applause_type`, `applause_show_level`, `applause_min_amount`, `applause_max_amount`, `applause_timeout`, `applause_particle_image_url`, `projector_countdown_default_time`, `projector_countdown_warning_time`, `export_csv_encoding`, `export_csv_separator`, `export_pdf_pagenumber_alignment`, `export_pdf_fontsize`, `export_pdf_line_height`, `export_pdf_page_margin_left`, `export_pdf_page_margin_top`, `export_pdf_page_margin_right`, `export_pdf_page_margin_bottom`, `export_pdf_pagesize`, `agenda_show_subtitles`, `agenda_enable_numbering`, `agenda_number_prefix`, `agenda_numeral_system`, `agenda_item_creation`, `agenda_new_items_default_visibility`, `agenda_show_internal_items_on_projector`, `agenda_show_topic_navigation_on_detail_view`, `list_of_speakers_amount_last_on_projector`, `list_of_speakers_amount_next_on_projector`, `list_of_speakers_couple_countdown`, `list_of_speakers_show_amount_of_speakers_on_slide`, `list_of_speakers_present_users_only`, `list_of_speakers_show_first_contribution`, `list_of_speakers_hide_contribution_count`, `list_of_speakers_allow_multiple_speakers`, `list_of_speakers_enable_point_of_order_speakers`, `list_of_speakers_can_create_point_of_order_for_others`, `list_of_speakers_enable_point_of_order_categories`, `list_of_speakers_closing_disables_point_of_order`, `list_of_speakers_enable_pro_contra_speech`, `list_of_speakers_can_set_contribution_self`, `list_of_speakers_speaker_note_for_everyone`, `list_of_speakers_initially_closed`, `list_of_speakers_default_structure_level_time`, `list_of_speakers_enable_interposed_question`, `list_of_speakers_intervention_time`, `motions_default_workflow_id`, `motions_default_amendment_workflow_id`, `motions_preamble`, `motions_default_line_numbering`, `motions_line_length`, `motions_reason_required`, `motions_origin_motion_toggle_default`, `motions_enable_origin_motion_display`, `motions_enable_text_on_projector`, `motions_enable_reason_on_projector`, `motions_enable_sidebox_on_projector`, `motions_enable_recommendation_on_projector`, `motions_hide_metadata_background`, `motions_show_referring_motions`, `motions_show_sequential_number`, `motions_create_enable_additional_submitter_text`, `motions_recommendations_by`, `motions_block_slide_columns`, `motions_recommendation_text_mode`, `motions_default_sorting`, `motions_number_type`, `motions_number_min_digits`, `motions_number_with_blank`, `motions_amendments_enabled`, `motions_amendments_in_main_list`, `motions_amendments_of_amendments`, `motions_amendments_prefix`, `motions_amendments_text_mode`, `motions_amendments_multiple_paragraphs`, `motions_supporters_min_amount`, `motions_enable_editor`, `motions_enable_working_group_speaker`, `motions_export_title`, `motions_export_preamble`, `motions_export_submitter_recommendation`, `motions_export_follow_recommendation`, `motion_poll_ballot_paper_selection`, `motion_poll_ballot_paper_number`, `motion_poll_default_type`, `motion_poll_default_method`, `motion_poll_default_onehundred_percent_base`, `motion_poll_default_group_ids`, `motion_poll_default_backend`, `motion_poll_projection_name_order_first`, `motion_poll_projection_max_columns`, `poll_candidate_list_ids`, `poll_candidate_ids`, `meeting_user_ids`, `users_enable_presence_view`, `users_enable_vote_weight`, `users_allow_self_set_present`, `users_pdf_welcometitle`, `users_pdf_welcometext`, `users_pdf_wlan_ssid`, `users_pdf_wlan_password`, `users_pdf_wlan_encryption`, `users_email_sender`, `users_email_replyto`, `users_email_subject`, `users_email_body`, `users_enable_vote_delegations`, `users_forbid_delegator_in_list_of_speakers`, `users_forbid_delegator_as_submitter`, `users_forbid_delegator_as_supporter`, `users_forbid_delegator_to_vote`, `assignments_export_title`, `assignments_export_preamble`, `assignment_poll_ballot_paper_selection`, `assignment_poll_ballot_paper_number`, `assignment_poll_add_candidates_to_list_of_speakers`, `assignment_poll_enable_max_votes_per_option`, `assignment_poll_sort_poll_result_by_votes`, `assignment_poll_default_type`, `assignment_poll_default_method`, `assignment_poll_default_onehundred_percent_base`, `assignment_poll_default_group_ids`, `assignment_poll_default_backend`, `poll_ballot_paper_selection`, `poll_ballot_paper_number`, `poll_sort_poll_result_by_votes`, `poll_default_type`, `poll_default_method`, `poll_default_onehundred_percent_base`, `poll_default_group_ids`, `poll_default_backend`, `poll_default_live_voting_enabled`, `topic_poll_default_group_ids`, `projector_ids`, `all_projection_ids`, `projector_message_ids`, `projector_countdown_ids`, `tag_ids`, `agenda_item_ids`, `list_of_speakers_ids`, `structure_level_list_of_speakers_ids`, `point_of_order_category_ids`, `speaker_ids`, `topic_ids`, `group_ids`, `meeting_mediafile_ids`, `mediafile_ids`, `motion_ids`, `forwarded_motion_ids`, `motion_comment_section_ids`, `motion_category_ids`, `motion_block_ids`, `motion_workflow_ids`, `motion_comment_ids`, `motion_submitter_ids`, `motion_editor_ids`, `motion_working_group_speaker_ids`, `motion_change_recommendation_ids`, `motion_state_ids`, `poll_ids`, `option_ids`, `vote_ids`, `assignment_ids`, `assignment_candidate_ids`, `personal_note_ids`, `chat_group_ids`, `chat_message_ids`, `structure_level_ids`, `logo_projector_main_id`, `logo_projector_header_id`, `logo_web_header_id`, `logo_pdf_header_l_id`, `logo_pdf_header_r_id`, `logo_pdf_footer_l_id`, `logo_pdf_footer_r_id`, `logo_pdf_ballot_paper_id`, `font_regular_id`, `font_italic_id`, `font_bold_id`, `font_bold_italic_id`, `font_monospace_id`, `font_chyron_speaker_name_id`, `font_projector_h1_id`, `font_projector_h2_id`, `committee_id`, `default_meeting_for_committee_id`, `organization_tag_ids`, `present_user_ids`, `user_ids`, `reference_projector_id`, `list_of_speakers_countdown_id`, `poll_countdown_id`, `projection_ids`, `default_projector_agenda_item_list_ids`, `default_projector_topic_ids`, `default_projector_list_of_speakers_ids`, `default_projector_current_los_ids`, `default_projector_motion_ids`, `default_projector_amendment_ids`, `default_projector_motion_block_ids`, `default_projector_assignment_ids`, `default_projector_mediafile_ids`, `default_projector_message_ids`, `default_projector_countdown_ids`, `default_projector_assignment_poll_ids`, `default_projector_motion_poll_ids`, `default_projector_poll_ids`, `default_group_id`, `admin_group_id`, `anonymous_group_id`, `relevant_history_entry_ids`];
}
