...
export class Motion extends BaseModel<Motion> implements MotionFormattingRepresentation {
    ...
    public static readonly REQUESTABLE_FIELDS: (keyof Motion)[] = [`id`, `number`, `sequential_number`, `title`, `text`, `amendment_paragraphs`, `modified_final_version`, `reason`, `category_weight`, `state_extension`, `recommendation_extension`, `sort_weight`, `created`, `last_modified`, `workflow_timestamp`, `start_line_number`, `forwarded`, `additional_submitter`, `lead_motion_id`, `amendment_ids`, `sort_parent_id`, `sort_child_ids`, `origin_id`, `origin_meeting_id`, `derived_motion_ids`, `all_origin_ids`, `all_derived_motion_ids`, `identical_motion_ids`, `state_id`, `recommendation_id`, `state_extension_reference_ids`, `referenced_in_motion_state_extension_ids`, `recommendation_extension_reference_ids`, `referenced_in_motion_recommendation_extension_ids`, `category_id`, `block_id`, `submitter_ids`, `supporter_meeting_user_ids`, `editor_ids`, `working_group_speaker_ids`, `poll_ids`, `change_recommendation_ids`, `comment_ids`, `agenda_item_id`, `list_of_speakers_id`, `tag_ids`, `attachment_meeting_mediafile_ids`, `projection_ids`, `personal_note_ids`, `meeting_id`, `history_entry_ids`];
}
