...
export class MotionHtmlToPdfService {
    /**
     ...
     *
     * @param htmlText The html text that should be converted to PDF.
     *
     * @returns {object} The converted html as DocDef.
     */
    public addPlainText(htmlText: string): object {
        return {
     ...
     */
    public convertHtml({ htmlText, lnMode, lineHeight }: HtmlToPdfConfig): object {
        const docDef = [];
