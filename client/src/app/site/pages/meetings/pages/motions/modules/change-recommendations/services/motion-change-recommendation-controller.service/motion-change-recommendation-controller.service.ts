...
> {
    ...
    public createMotionChangeRecommendationTemplate(motion: ViewMotion, lineRange: LineRange, lineLength: number): any {
        ...
        changeReco.text = lineRange.to <= this.lineNumberingService.getLineNumberRange(motionText).to ? this.diffService.extractMotionLineRange(motionText, lineRange, false, lineLength) : ``;
