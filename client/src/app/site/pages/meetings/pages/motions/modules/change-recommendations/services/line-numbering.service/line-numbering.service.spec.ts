...
describe(`LineNumberingService`, () => {
    ...
    describe(`line numbering: inline nodes`, () => {
        it(`leaves a simple SPAN untouched`, inject([LineNumberingService], (service: LineNumberingService) => {
            ...
            const outHtml = service.insertLineNumbers({
                html: inHtml,
                lineLength: 5,
                firstLine: 1
            });
    ...
    describe(`line numbering in regard to the inline diff`, () => {
        it(`does not count within INS nodes`, inject([LineNumberingService], (service: LineNumberingService) => {
            ...
            const outHtml = service.insertLineNumbers({ html: inHtml, lineLength: 10, firstLine: 1 });
    ...
    describe(`document structure parsing`, () => {
        ...
        xit(`detects the line numbers of headings`, inject([LineNumberingService], (service: LineNumberingService) => {
            ...
            inHtml = service.insertLineNumbers({ html: inHtml, lineLength: 80, firstLine: 1 });
    ...
    describe(`caching`, () => {
        it(`caches based on line length`, inject([LineNumberingService], (service: LineNumberingService) => {
            ...
            const outHtml80 = service.insertLineNumbers({ html: inHtml, lineLength: 80, firstLine: 1 });
            const outHtml70 = service.insertLineNumbers({ html: inHtml, lineLength: 70, firstLine: 1 });
