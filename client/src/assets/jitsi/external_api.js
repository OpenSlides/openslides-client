                ...
                820: (e, t, n) => {
                    ...
                    function h(e) {
                        ...
                        if (
                            ...
                            (-1 !== o && ((t.port = r.substring(o + 1)), (r = r.substring(0, o))), (t.hostname = r));
                        }
                        if (
                            ((n = new RegExp('^([^?#]*)', 'gi')),
                            (i = n.exec(e)),
                    ...
                    function g(e) {
                        ...
                        if (!n.host) {
                            ...
                            if (t) {
                                const { host: e, hostname: r, pathname: s, port: o } = h(d(`org.jitsi.meet://${t}`));
                        ...
                        s && c.set('jwt', s);
                        const { defaultLanguage: l } = e.configOverwrite || {};
                        ...
                        constructor() {
                            ...
                            ((this.postis = (function (e) {
                                ...
                                var h = {
                                        ...
                                        send: function (e) {
                                            var t = e.method;
                                            (l || e.method === d) && i && 'function' == typeof i.postMessage
                                                ? i.postMessage(
                                                      JSON.stringify({
                                                          postis: !0,
                                                          scope: n,
                    ...
                    class b {
                        constructor() {
                            let { backend: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                ...
                7: e => {
                    ...
                    function o(e, n, i, r) {
                        ((this.id = n),
                            ...
                            (this.level = t[e]));
                        for (var o = Object.keys(t), a = 0; a < o.length; a++) this[o[a]] = s.bind(null, this, o[a]);
                    }
                ...
                620: e => {
                    ...
                    function l(e, t, n, i) {
                        ...
                        if (
                            ...
                            ('function' == typeof o ? (o = s[t] = i ? [n, o] : [o, n]) : i ? o.unshift(n) : o.push(n),
